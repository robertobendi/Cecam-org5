...
You are building the public face of **robertobendi/Cecam-org5** (modeled after https://www.cecam.org/). Target: GitHub
...
user can log into the local admin later):
    ...
    ADMIN_PASSWORD="bis-2saXlVnff23T1b" \
    ADMIN_NAME="Admin" \
    SITE_NAME="Cecam Org5" \
